...
//Dependencies
// #include "m460.h" //include removed by Cocilova Marco to avoid firmware implementation
#include <Cyclone\cycloneCrypto\core\crypto.h> //"core/crypto.h"
// #include "hardware/m460/m460_crypto.h" //include removed by Cocilova Marco to avoid firmware implementation
#include <Cyclone\cycloneCrypto\hardware\m460\m460_crypto_pkc.h> //"hardware/m460/m460_crypto_pkc.h"
#include <Cyclone\cycloneCrypto\pkc\rsa.h> //"pkc/rsa.h"
#include <Cyclone\cycloneCrypto\ecc\ec.h> //"ecc/ec.h"
#include <Cyclone\cycloneCrypto\ecc\curve25519.h> //"ecc/curve25519.h"
#include <Cyclone\cycloneCrypto\ecc\curve448.h> //"ecc/curve448.h"
...
// error_t mpiExpModFast(Mpi *r, const Mpi *a, const Mpi *e, const Mpi *p) //function commented by Cocilova Marco to avoid firmware ambient definition
// {
//    error_t error;
//    size_t aLen;
//    size_t eLen;
...
// error_t mpiExpModRegular(Mpi *r, const Mpi *a, const Mpi *e, const Mpi *p) //function commented by Cocilova Marco to avoid firmware ambient definition
// {
//    error_t error;
//    size_t aLen;
//    size_t eLen;
...
//    const EcPoint *s) //function commented by Cocilova Marco to avoid firmware ambient definition
// {
//    error_t error;
//    uint_t modLen;
//    uint_t scalarLen;
