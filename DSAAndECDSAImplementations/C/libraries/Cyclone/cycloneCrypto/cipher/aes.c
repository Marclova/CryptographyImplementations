...
/*__weak_func*/ error_t aesInit(AesContext *context, const uint8_t *key,
   size_t keyLen) //__weak_func tag removed by Cocilova Marco
{
   uint_t i;
   uint32_t temp;
...
/*__weak_func*/ void aesEncryptBlock(AesContext *context, const uint8_t *input,
   uint8_t *output) //__weak_func tag removed by Cocilova Marco
{
   uint_t i;
   uint32_t s0;
   uint32_t s1;
...
/*__weak_func*/ void aesDeinit(AesContext *context) //__weak_func tag removed by Cocilova Marco
{
   //Clear AES context
